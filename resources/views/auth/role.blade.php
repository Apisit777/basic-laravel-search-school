                    ...
                    <form id="from_user" class="group js-validation-signin" action="javascript:void(0)" method="POST">
                        ...
                        <div class="flex flex-col">
                            <div class="flex w-full flex-col items-start ">
                                ...
                                <input type="text" name="username" id="username" class="h-10 rounded-sm px-4 w-full text-center bg-[#e7e7e7] border border-gray-900 text-blue-600 dark:text-blue-600 text-base font-semibold focus:ring-blue-500 focus:border-blue-500 block p-2.5 cursor-not-allowed dark:bg-[#101010] dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ Auth::user()->username }}" readonly>
                            ...
                            <!-- <div class="relative float-label-input -mt-8">
                                <select class="js-example-basic-single w-full bg-white dark:bg-[#2020] rounded-sm text-xs" name="name_position">
