...
@section('content')
    ...
    {{-- <div class="App w-full bg-[#E7EDEF] dark:bg-[#505050] flex justify-center items-center relative"> --}}
    ...
    <body x-cloak x-data="{darkMode: $persist(false)}" :class="{'dark': darkMode === true }" class="antialiased">
        <!-- <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen  bg-white dark:bg-black  selection:text-white"> -->
        {{-- <div class="scale-100 p-2 bg-[#e9e9e9] dark:bg-[#202020] from-gray-700/50 via-transparent"> --}}
        <div class="scale-100 ml-72 p-2 bg-[#e9e9e9] dark:bg-[#202020] from-gray-700/50 via-transparent">
