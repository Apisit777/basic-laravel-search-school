        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                ...
                <div id="dropdownAvatarName" class="p-1.5 z-10 hidden text-center bg-white divide-y divide-gray-600 rounded-sm shadow w-auto md:w-60 border-none dark:bg-[#303030] dark:divide-gray-600">
                    ...
                    <!-- <ul class="flex items-center justify-center text-sm text-gray-700 dark:text-gray-200">
                        <li id="auth_department" class="py-2 px-2"></li>
                    </ul> -->
                    <div class="flex items-center justify-center text-black dark:text-white text-sm">
                        <a href="{{ route('logout') }}" class="text-black dark:text-white py-2 px-2 rounded-sm group">
                            <svg fill="currentColor" class="mt-1 hidden h-5 w-5 transition-transform group-hover:translate-x-1 rtl:rotate-180 rtl:group-hover:-translate-x-1 md:inline-block" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
