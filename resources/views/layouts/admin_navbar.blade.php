                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button-1">
                            ...
                            <li>
                                <div class="text-black dark:text-white text-sm ml-2 mt-1">
                                    <a href="{{ route('logout') }}" class="text-black dark:text-white py-1 px-2 rounded-sm group">
                                        ...
                                        <svg fill="currentColor" class="mt-0.5 hidden h-5 w-5 transition-transform group-hover:translate-x-1 rtl:rotate-180 rtl:group-hover:-translate-x-1 md:inline-block" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
