                ...
                <ul class="space-y-2 text-sm font-medium">
                    @if (!empty($menu['getPermissionSubmenus'][0]))
                        <li class="relative w-[232px] overflow-hidden group mt-2">
                            ...
                            @if ($menu['menu_name'] == 'Manage Menu' || $menu['menu_name'] == 'Product Master' || $menu['menu_name'] == 'Product Detail')
                                <div class="flex peer duration-500 {{ Request::is($menu['url'].'*') ? 'rounded-sm text-white dark:text-white !bg-[#05395D] !dark:bg-[#05395D] border-2 border-[#1f95de] duration-500': '' }}">
                            ...
                            @foreach($menu['getPermissionSubmenus'] as $submenu)
                                <ul class="bg-[#f9f9f9] dark:bg-[#232323] overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-40 h-fit after:absolute after:left-[0.95rem] after:top-[2.5rem] after:mt-px after:h-[calc(100%-2.45rem)] after:w-px after:bg-neutral-200 after:content-[''] dark:after:bg-gray-600">
                                    <li>
                                        <a class="flex items-center w-full p-1 text-gray-900 transition rounded-sm pl-12 group hover:bg-neutral-800/50 dark:text-white dark:hover:bg-[#303030] {{ Request::is($menu['url'].'/'.$submenu['url'].'*') ? 'rounded-sm text-white dark:text-white !bg-[#05395D] !dark:bg-[#05395D] border-2 border-[#1f95de] duration-500': '' }}" href="{{ '/'.$menu['url'].'/'.$submenu['url'] }}">
                                            {{ $submenu->name }}
                                        </a>
                                    </li>
                                </ul>
                    ...
                    @else
                        @if ($menu['menu_name'] == 'Product Channel')
                            <li class="mt-2">
                                <a class="flex items-center p-1 text-gray-900 rounded-sm dark:text-white hover:bg-neutral-800/50 dark:hover:bg-[#303030] group {{ Request::is($menu['url'].'*') ? 'rounded-sm dark:text-white !bg-[#05395D] !dark:bg-[#05395D] border-2 border-[#1f95de] duration-500': '' }}" href="{{ '/'.$menu['url'] }}">
