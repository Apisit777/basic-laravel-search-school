...
<aside id="logo-sidebar" class="sidebar fixed top-12 left-0 z-40 w-64 h-screen -translate-x-full border-r border-gray-200 md:translate-x-0 dark:border-gray-700 transition-all duration-500" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-[#202020] duration-500 mt">
            ...
            <ul class="space-y-2 font-medium">
                @if (!empty($menu['getPermissionSubmenus'][0]))
                    <li class="relative w-[232px] overflow-hidden group mt-2">
                        ...
                        <div class="flex peer duration-500 {{ Request::is($menu['url'].'*') ? 'rounded-sm bg-primary-300 dark:bg-[#014a77] duration-500': '' }}">
                            ...
                            <div class="bg-white text-white h-10 w-full pl-2.5 flex items-center duration-500  {{ Request::is($menu['url'].'*') ? 'rounded-sm bg-primary-300 dark:bg-[#014a77] duration-500': 'dark:bg-[#202020] duration-500' }}">
                        ...
                        @foreach($menu['getPermissionSubmenus'] as $submenu)
                            <ul class="bg-[#f9f9f9] dark:bg-[#232323] overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-40 h-fit after:absolute after:left-[1.20rem] after:top-[2.5rem] after:mt-px after:h-[calc(100%-2.45rem)] after:w-px after:bg-neutral-200 after:content-[''] dark:after:bg-gray-700">
                                <li>
                                    <a class="flex items-center w-full p-1.5 text-gray-900 transition duration-75 rounded-sm pl-12 group hover:bg-gray-200 dark:text-white dark:hover:bg-[#303030] {{ Request::is($menu['url'].'/'.$submenu['url'].'*') ? 'rounded-sm bg-primary-300 dark:bg-[#014a77] duration-500': '' }}" href="{{ '/'.$menu['url'].'/'.$submenu['url'] }}">
                                        {{ $submenu->name }}
                                    </a>
                                </li>
                            </ul>
                ...
                @else
                    <li class="mt-2">
                        <a class="flex items-center p-2 text-gray-900 rounded-sm dark:text-white hover:bg-gray-200 dark:hover:bg-[#303030] group {{ Request::is($menu['url'].'*') ? 'rounded-sm bg-primary-300 dark:bg-[#014a77] duration-500': '' }}" href="{{ '/'.$menu['url'] }}">
        ...
        <!-- <ul class="space-y-2 font-medium">
            ...
            <li>
                <a class="flex items-center p-2 text-gray-900 rounded-sm dark:text-white hover:bg-gray-100 dark:hover:bg-[#303030] group {{ (request()->is('product') || request()->is('product/*')) ? 'rounded-sm bg-primary-100 dark:bg-[#014a77] duration-500' : '' }}" href="{{ route('product.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    <path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" />
                    </svg>
