...
@section('content')
    <div class="justify-center items-center">
        ...
        <a
            ...
            class="xs:mt-0 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0 mr-16 px-1.5 py-1 font-bold tracking-wide bg-[#303030] hover:bg-[#404040] text-white rounded cursor-pointer group" name="" id=""
        >
