...
@section('content')
    ...
    <div class="bg-white rounded shadow-lg dark:bg-[#232323] duration-500 p-4 px-4 md:p-8 mt-10 relative">
                    ...
                    <div class="grid mt-5 gap-4 gap-y-2 text-sm text-gray-900 dark:text-gray-100 grid-cols-1 lg:grid-cols-4">
                        ...
                        <div class="lg:col-span-3">
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                                ...
                                <div class="md:col-span-6" style="position: relative;">
                                    <label for="name">ชื้อสินค้า<span class="text-danger"> *</span></label>
