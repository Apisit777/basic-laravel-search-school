...
@section('content')
    ...
    <div class="justify-center items-center">
        ...
        <div class="fixed flex bottom-5 right-5 z-10">
            <a href="{{ route('new_product_develop_creat') }}" class="text-gray-100 bg-[#303030] hover:bg-[#404040] text-white font-bold py-2 px-2 mr-2 mt-20 rounded-full group">
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="inline-flex items-center rounded-md shadow-sm">
                                    ...
                                    <button type="button" class="px-1 py-1 font-medium tracking-wide bg-[#303030] hover:bg-[#404040] text-white py-1 px-1 rounded group">
